...
// the double slashes "//" in this document are comments!  Whenever you use them the compiler won't read this line of code
/* 
you can
make
multi-line
comments with "*" and "/" like this
*/
...
// Use camelCaseNotation (first letter of first word is small but the rest are capitalized) or PascalNotation (first letter of every word is big)
// for variables you should use camelCase 99.999% of the time
...
// You can define a variable on the fly - DONT DO THIS, it's just interesting :D!
...
console.log(goodIndoorPlant); // undefined
var goodIndoorPlant = "Now it's defined"; 			
...
var architecturalStyle = 'Art Deco'; // use single quotes, they can work too and no one really cares.
var funWord = "onomatopoeia's" // they are especially good for anything with an appostrophy '
var goodQuestion = '37';
...
console.log(kittyHawk(1909));

// Functions can take an infinite number of parameters by separating them with a comma like this:

function intro(name, age, favoriteFood) {
 return 'hi, my name is' + name + 'and I am ' + age + 'years old!  My favorite food is ' + favoriteFood;
}

console.log(intro('Trevor', '40', 'tacos'));
